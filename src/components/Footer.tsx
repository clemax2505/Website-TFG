        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/contact" className="text-gray-700 hover:text-forge-orange dark:text-gray-400">Contact</Link></li>
              <li><Link to="/services" className="text-gray-700 hover:text-forge-orange dark:text-gray-400">Services</Link></li>
            </ul>
          </div>
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/the_gaming_forge/" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-forge-orange dark:text-gray-400">
